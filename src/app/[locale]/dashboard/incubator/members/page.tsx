...
export default async function IncubatorMembersPage({ params }: PageProps) {
  ...
  return (
    <div className="space-y-6">
      <DashboardPageHeader
        title={t('incubator.members.title')}
        subtitle={t('incubator.members.subtitle', { count: members.length })}
      />
