...
test.describe('Membership pricing — config, purchase, frozen snapshot', () => {
  ...
  test.beforeAll(async () => {
    ...
    // Visiting the admin Commissions page is what seeds plan configs in normal
    // use; hitting a no-op PATCH achieves the same from the API side and makes
    // the suite independent of page-visit order.
